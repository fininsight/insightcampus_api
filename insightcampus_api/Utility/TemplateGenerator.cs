...
namespace insightcampus_api.Utility
{
    public static class TemplateGenerator
    {
        ...
        {   
                ...
                sb.AppendFormat($@"
                    <div class='content'>
                        ...
                        <table cellpadding='5'>
                            ...
                            <tr class='price-line'>
                                <td>₩{ToAccounting(employee_all)}</td>
                                <td>₩{ToAccounting(employee_vat)}</td>
                                <td id='bg-lightyellow'>₩{ToAccounting(employee_all + employee_vat)}</td>
                            </tr>
                        </table>
                        <br />
                        <br />
            ...
            {
                sb.AppendFormat($@"
                    <h1><span id='bg-yellow'>[핀인사이트 기준 강의료]</span></h1>
                    <table cellpadding='5'>
                        <tr id='bg-grey'>
                            <td>총 강의료</td>
                            <td>원천징수액</td>
            ...
            {
                sb.AppendFormat($@"
                                    <h1><span id='bg-yellow'>[송금액(회수 금액)]</span></h1>
                                    <table cellpadding='5'>
                                        <tr id='bg-grey'>
                                            <td>송금액 계산</td>
                                            <td id='bg-yellow'>송금액</td>
